...
public class LuaFrameworkController : IController {
    ...
    protected LuaFrameworkController() {
        InitializeController();
    }

    static LuaFrameworkController() {
    }
        ...
        get {
            if (m_instance == null) {
                lock (m_staticSyncRoot) {
                    if (m_instance == null) m_instance = new LuaFrameworkController();
                }
            }
            return m_instance;
        }
    ...
    public virtual void ExecuteCommand(IMessage note) {
        ...
        if (commandType != null) {  //LuaFrameworkController
