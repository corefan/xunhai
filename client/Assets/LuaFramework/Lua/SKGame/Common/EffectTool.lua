...
function EffectTool.AddEffect(modelId, effectName, target, lifeTime, targetIsParent, boneName, targetPos, scale, isWarning)
	...
	-- flyEff:SetEffect("animation_run_21301", "character/bingjian/animation_run_21301.unity3d", SceneController:GetInstance():GetScene().playerList[2], self.mainPlayer.transform)
