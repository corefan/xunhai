...
public class FairyGUI_UIContentScalerWrap
{
	...
	static int get_scaleMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index scaleMode on a nil value" : e.Message);
		}
	}
	...
	static int get_designResolutionX(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index designResolutionX on a nil value" : e.Message);
		}
	}
	...
	static int get_designResolutionY(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index designResolutionY on a nil value" : e.Message);
		}
	}
	...
	static int get_constantScaleFactor(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.UIContentScaler obj = (FairyGUI.UIContentScaler)o;
			int ret = obj.constantScaleFactor;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index constantScaleFactor on a nil value" : e.Message);
		}
	}
