...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetLoaderManager", GetLoaderManager);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetLoaderManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.LoaderManager o = LuaFramework.LuaHelper.GetLoaderManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
