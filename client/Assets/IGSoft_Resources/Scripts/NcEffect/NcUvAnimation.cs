...
public class NcUvAnimation : NcEffectAniBehaviour
{
    ...
    protected float startScrollSpeedX = 1.0f;
    protected float startScrollSpeedY = 0.0f;

    protected float startTilingX = 1;
    protected float startTilingY = 1;

    protected float startOffsetX = 0;
    protected float startOffsetY = 0;

    public override void RecordStartState()
    {
        base.RecordStartState();
        startScrollSpeedX = m_fScrollSpeedX;
        startScrollSpeedY = m_fScrollSpeedY;
        startTilingX = m_fTilingX;
        startTilingY = m_fTilingY;
        startOffsetX = m_fOffsetX;
        startOffsetY = m_fOffsetY;
    }

    public override void ResetToStartState()
    {
        base.ResetToStartState();
        m_fScrollSpeedX = startScrollSpeedX;
        m_fScrollSpeedY = startScrollSpeedY;
        m_fTilingX = startTilingX;
        m_fTilingY = startTilingY;
        m_fOffsetX = startOffsetX;
        m_fOffsetY = startOffsetY;
    }
}
