...
public class NcSpriteFactory : NcEffectBehaviour
{
    ...
    {
        //   		Log.info("GetSpriteUvRect() - m_SpriteList.Count = " + m_SpriteList.Count + ", nStriteIndex = " + nStriteIndex + ", nFrameIndex = " + nFrameIndex);
    ...
    void CreateEffectObject()
    {
        ...
        if (m_bShowEffect == false)
            return;
        DestroyEffectObject();
        // 		Log.info("CreateEffectObject() - new = " + ncSpriteNode.m_EffectPrefab);
    ...
    {
        //  		Log.info("DestroyEffectObject - " + m_CurrentEffect);
    ...
    {
        // 		Log.info("OnChangingSprite() - nOldNodeIndex = " + nOldNodeIndex + ", nNewNodeIndex = " + nNewNodeIndex);
    ...
    {
        // 		Log.info("OnAnimationChangingFrame() - nOldIndex = " + nOldIndex + ", nNewIndex = " + nNewIndex + ", nLoopCount = " + nLoopCount + ", m_nCurrentIndex = " + m_nCurrentIndex);
    ...
    {
        // 		Log.info(ncSpriteFrameInfo.m_FrameUvOffset);
        ...
        //  			Log.info(meshFilter.mesh.vertices[n]);
    }
