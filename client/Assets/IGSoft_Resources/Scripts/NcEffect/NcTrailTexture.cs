...
public class NcTrailTexture : NcEffectBehaviour
{
    ...
    public override string CheckProperty()
    {
        ...
        if (this.gameObject.GetComponent<Renderer>().sharedMaterial == null)
    ...
    void Start()
    {
        if (this.gameObject.GetComponent<Renderer>() == null || this.gameObject.GetComponent<Renderer>().sharedMaterial == null)
        {
            enabled = false;
            return;
        }
    ...
    void InitTrailObject()
    {
        ...
        m_TrialObject.GetComponent<Renderer>().sharedMaterial = this.gameObject.GetComponent<Renderer>().sharedMaterial;
                ...
                if (make)
                {
                    ...
                    if (m_bInterpolation)
                    {
                        ...
                        if (nMinSmoothCount <= m_Points.Count)
                        {
                            ...
                            //Log.info(" smoothTipList.Count: " + smoothTipList.Count);
                            ...
                            for (int n = 0; n < smoothTipList.Count; ++n)
                            {
                                ...
                                //else
                                //{
                                //	StarEngine.Debuger.LogWarning(idx + "/" + m_SmoothedPoints.Count);
                                //}
                            }
                        }
                    }
    ...
    public override void RecordStartState()
    {
        ...
        m_fEmitTimeOnStart = m_fEmitTime;
        m_fLifeTimeOnStart = m_fLifeTime;
    }
    ...
    public override void ResetToStartState()
    {
        ...
        m_fEmitTime = m_fEmitTimeOnStart;
        m_fLifeTime = m_fLifeTimeOnStart;
        m_bEmit = true;
        m_fStopTime = 0;
    }
}
