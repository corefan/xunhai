...
sEmptyTable:"没有找到相关数据",sInfo:"从 _START_ 到 _END_ 条数据 / 共  _TOTAL_ 条数据",sInfoEmpty:"从 0 到 0 条 -- 共  0 条",sInfoFiltered:"(共 _MAX_ 条数据)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 条",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查找 :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有匹配的信息"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
