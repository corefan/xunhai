 ...
 * Generated at: 2018-09-03 03:33:38 UTC
...
public final class keyAccount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (data != null) {
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(document).on(\"click\", \"#table_1 .username\", function(){\r\n");
      out.write("\t\t\tvar id = \"\";\r\n");
      out.write("\t\t\tvar gamesite = \"\";\r\n");
      out.write("\t\t\tvar num = 1;\r\n");
      out.write("\t\t\t$(this).parent().children().each(function(){\r\n");
      out.write("\t\t\t\tif (num == 2) {\r\n");
      out.write("\t\t\t\t\tid = this.innerHTML;\r\n");
      out.write("\t\t\t\t} else if (num == 6) {\r\n");
      out.write("\t\t\t\t\tgamesite = $(this).attr(\"class\");\r\n");
      out.write("\t\t\t\t} else if (num > 6) {\r\n");
      ...
      out.write("            var height = 640;\r\n");
      out.write("            var top = (window.screen.availHeight - height) / 2;\r\n");
      out.write("  \t\t\tvar left = (window.screen.availWidth - width) / 2;\r\n");
      out.write("            \r\n");
      out.write("            window.open(\"");
      out.print(path );
      out.write("/accountAnalysis?optType=");
      out.print(OptTypeConstant.ACCOUNT_ANALYSIS_3);
      out.write("&gameSite=\" + gamesite + \"&id=\" + id, \"newwindow\", \"height=\" + height + \", width=\" + width + \", top=\" + top + \", left=\" + left + \" toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no\");\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
	...
	if (request.getAttribute("pageIndex") != null) {
      ...
      out.print(path );
      out.write("/accountAnalysis\" method=\"post\" style=\"display:inline;\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"optType\" value=\"");
      out.print(OptTypeConstant.ACCOUNT_ANALYSIS_1);
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" value=\"刷新\" class=\"btn_1\" />\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"content_panel\">\r\n");
      out.write("\t\t\t\t\t<div class=\"content_panel_title\">\r\n");
      out.write("\t\t\t\t\t\t<h3>大客户管理</h3>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>排名</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>账户编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>支付区服</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>累计充值</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>近7天充值</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>近一月充值</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>末次充值时间</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(obj.getString("uid"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(obj.getString("paySites") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(obj.getString("summoney"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(obj.getString("sevenPay"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(obj.getString("monthPay"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(obj.getString("lastTime"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
