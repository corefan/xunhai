 ...
 * Generated at: 2018-09-03 03:33:34 UTC
...
public final class loginPlayer_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/* 								rows[4] += "<td>" + obj.getString("regOneWeek") + "</td>";
      ...
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>登录用户数</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(rows[1]);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>新注册用户</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(rows[2]);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>老用户数</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(rows[3]);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
