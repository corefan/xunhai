...
<%
	...
	JSONArray guildTaskData = new JSONArray();
	String dataStr = "";
	if (data != null && !data.isNull("dataList")) {
		guildTaskData = (JSONArray) data.getJSONArray("dataList");
		if (guildTaskData.length() > 0) {
			JSONObject obj = guildTaskData.getJSONObject(guildTaskData.length() - 1);
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-23" data-genuitec-path="/OperationAnalysis/WebRoot/guildTask.jsp">
	<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-23" data-genuitec-path="/OperationAnalysis/WebRoot/guildTask.jsp">
		<div class="header">
			...
			<div class="content">
				<div class="content_top">
					<form action="<%=path %>/behaviorAnalysis" method="post">
						<input type="hidden" name="optType" value="<%= OptTypeConstant.BEHAVIOR_ANALYSIS_9%>" />
				...
				<div class="content_panel">
					...
					<div class="content_panel_content">
						...
						<table id="table_1" class="display" cellspacing="0" width="100%">
							...
							<tbody>
								<%
									for (int i = 0; i < guildTaskData.length(); i++) {
										JSONObject obj = guildTaskData.getJSONObject(i);
