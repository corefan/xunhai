...
<script type="text/javascript" language="javascript">
	$(function() {
		...
		$('#chart_1').highcharts({
			...
			xAxis : {
				categories : ["次日","3日","4日","5日","6日","7日","双周","月"]
			},
			yAxis : {
				title : {
					text : '留存率'
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-38" data-genuitec-path="/OperationAnalysis/WebRoot/retain.jsp">
	<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-38" data-genuitec-path="/OperationAnalysis/WebRoot/retain.jsp">
		<div class="header">
