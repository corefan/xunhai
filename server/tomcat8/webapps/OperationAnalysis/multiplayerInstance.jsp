...
<%
	...
	JSONArray multiplayerInstanceData = new JSONArray();
	String dataStr = "";
	if (data != null) {
		multiplayerInstanceData = (JSONArray) data.getJSONArray("dataList");
		if (multiplayerInstanceData.length() > 0) {
			JSONObject obj = multiplayerInstanceData.getJSONObject(multiplayerInstanceData.length() - 1);
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-34" data-genuitec-path="/OperationAnalysis/WebRoot/multiplayerInstance.jsp">
	<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-34" data-genuitec-path="/OperationAnalysis/WebRoot/multiplayerInstance.jsp">
		<div class="header">
			...
			<div class="content">
				<div class="content_top">
					<form action="<%=path %>/behaviorAnalysis" method="post">
						<input type="hidden" name="optType" value="<%= OptTypeConstant.BEHAVIOR_ANALYSIS_3%>" />
				...
				<div class="content_panel">
					...
					<div class="content_panel_content">
						...
						<table id="table_1" class="display" cellspacing="0" width="100%">
							...
							<tbody>
								<%
									for (int i = 0; i < multiplayerInstanceData.length(); i++) {
										JSONObject obj = multiplayerInstanceData.getJSONObject(i);
