...
<%
	...
	JSONArray alchemyData = new JSONArray();
	String dataStr = "";
	if (data != null && !data.isNull("dataList")) {
		alchemyData = (JSONArray) data.getJSONArray("dataList");
		if (alchemyData.length() > 0) {
			JSONObject obj = alchemyData.getJSONObject(alchemyData.length() - 1);
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/OperationAnalysis/WebRoot/alchemy.jsp">
	<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/OperationAnalysis/WebRoot/alchemy.jsp">
		<div class="header">
			...
			<div class="content">
				<div class="content_top">
					<form action="<%=path %>/behaviorAnalysis" method="post">
						<input type="hidden" name="optType" value="<%= OptTypeConstant.BEHAVIOR_ANALYSIS_7%>" />
				...
				<div class="content_panel">
					...
					<div class="content_panel_content">
						...
						<table id="table_1" class="display" cellspacing="0" width="100%">
							...
							<tbody>
								<%
									for (int i = 0; i < alchemyData.length(); i++) {
										JSONObject obj = alchemyData.getJSONObject(i);
