...
public class CacheSynDBService {
	...
	private static void initOneSecondLogCacheMap() {
		oneMinuteInsertCacheLogMap.put(CacheConstant.OPT_LOG_CACHE, Collections.synchronizedList(new ArrayList<OptLog>()));
	 }
	  ...
	  * @return 当前缓存中的所有数据
	  */
	 public static List<List<?>> getAllAndClearLogCache_one_min_insert() {
