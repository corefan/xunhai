package com.cc.core.net
{
	...
	public class GameCCSocket extends Socket
	{
		...
		public  function tencentProtocol() : void {
			var str : String = makeTecentTWG(Config.host+":"+Config.port);
			var TGWByte : ByteArray = new ByteArray();
			TGWByte.writeMultiByte(str, "GBK");
			writeBytes(TGWByte);
			flush();
		}

		
		public static function makeTecentTWG(url : String) : String {
			// ref:http://wiki.open.qq.com/wiki/TGW
