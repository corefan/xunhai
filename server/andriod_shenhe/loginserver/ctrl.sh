#!/bin/sh   
 ...
 'start')
   ...
   #    echo "Starting the Service"
         nohup java -server -Xmx1024m -Xms800m -Xmn512m -Xss256k -classpath $CURPATH/bin:$CLASSPATH com.core.LoginServer ${CURPATH} > ${CURPATH}/nohup.out&
 ...
 'stop')
    ...
    if [ ! -z "$PID" ] ; then
               #echo "Stopping the Service, begin killing ${PID}"
                nohup java -classpath $CURPATH/bin:$CLASSPATH com.core.LoginClose ${CURPATH} > ${CURPATH}/nohup.out&
    fi    
    ;;   
 *)     
