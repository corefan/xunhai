...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=1210963267586 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='账号表';

-- ----------------------------
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES ('1208542695425', '5b9f770c66bc4', '123456', null, '1', '[1]', null, null, '2018-09-17 17:50:16', null);
INSERT INTO `account` VALUES ('1208542695426', '5b9f7f985ba38', '123456', null, '1', '[1]', null, null, '2018-09-17 18:19:12', null);
INSERT INTO `account` VALUES ('1210963267585', '5ba09963c1627', '123456', null, '1', '[1]', null, null, '2018-09-18 14:21:25', null);
...
CREATE TABLE `log_pay` (
  ...
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=1197479916109827 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='支付记录';
